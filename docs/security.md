...
| Workload Identity CA policy | ⚠️ Gap | Requires Entra Workload ID Premium — risk accepted |
...
|---|---|---|
| No Workload Identity CA (IP restriction) | Low | Mitigated by cert-only auth and isolated app regs. CA policy script ready — needs Workload ID Premium license to activate. |
