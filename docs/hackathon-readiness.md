...
| Public release | Ready | Installer and portable ZIP are attached to GitHub Release v1.1.8 |
...
instructions now point to the actual v1.1.8 GitHub Release assets.
...
- GitHub Release v1.1.8 contains installer and portable ZIP assets.
