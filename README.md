...
Download `JML.Console.Setup.1.1.2.exe` from the [v1.1.2 GitHub Release](https://github.com/TrickyDanceMoves/jml-agent-fleet/releases/tag/v1.1.2). No admin rights are required; it installs per-user to `%LOCALAPPDATA%\Programs\JML Console\`.
